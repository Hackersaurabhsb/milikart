...
def download_pdf(obj):
    ...
    return mark_safe(f'<a href={url}>See Invoice</a>')
download_pdf.short_description="Invoice"
...
class OrderAdmin(admin.ModelAdmin):
    ...
    'postal_code','city','paid',order_payment,'created','updated',order_detail,download_pdf]
    list_filter=['paid','created','updated']
    inlines=[Order_item_inline]
    actions=[export_to_csv]#to add this action into orderadmin class
